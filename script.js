let tarefas = [
    ['Tarefa Renan', 'mat', '(Ap. 8 - M. 47 - Pág. 31)', '(921, 922, 924, 933, 934)'],  //falta colocar  
    ['Tarefa Gui', 'his', '(Ap. 8 - M. 44 - Pág. 35)', '(862, 863, 864, 865, 866, 871, 872, 873, 880)'],
    ['Tarefa Fefo', 'lit', '(Ap. 8 - M. 48 - Pág. 182)', '(941, 942, 950, 951, 956, 959, 960)'],
    ['Tarefa Vini', 'mat', '(Ap. 8 - M. 44 - Pág. 54)', '(861, 862, 865, 866, 872, 875, 876)', '(Desafios: 863, 874)'],
    ['Tarefa Vlad', 'his', '(Ap. 8 - M. 23 - Pág. 237)', '(442, 443, 446, 452, 455, 458, 460)'],
]
