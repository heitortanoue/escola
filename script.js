let tarefas = [
    ['Tarefa Ditomaso', 'bio', '(Ap. 6 - M. 18 - Pág. 326)', '(341, 343, 346, 351, 354, 360)'],          
    ['Tarefa João César', 'fis', '(Ap. 7 - M. 40 - Pág. 24)', '(782, 785, 787, 788, 792, 796)'],   
    ['Tarefa Guilherme', 'his', '(Ap. 7 - M. 38 - Pág. 161)', '(741, 742, 744, 746, 747, 749, 750, 753)'],     
    ['Tarefa Fefo', 'lit', '(Ap. 8 - M. 43 - Pág. 159)', '(841, 842, 848, 850, 852, 854)'],    
    ['Tarefa Thiagão', 'fis', '(Ap. 6 - M. 18 - Pág. 119)', '(342, 343, 347, 350, 354)'],
    ['Tarefa Rose', 'qui', '(Ap. 8 - M. 43 - Pág. 111)', '(841, 847, 848, 854, 855, 858, 860)'],  

   //['Tarefa LeoGeo', 'geo', '(Ap. 7 - M. 36 - Pág. 179)', '(701, 703, 705, 711, 713, 715, 710, 713)'], 
