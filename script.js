let tarefas = [     
    ...
    ['Tarefa João César', 'fis', '(Ap. 7 - M. 39 - Pág. 20)', '(761, 768, 772, 773, 776, 778)','(Lista no Drive)'],    
    ['Tarefa Gui', 'his', '(Ap. 7 - M. 38 - Pág. 43)', '(741, 744, 745, 746, 747, 748, 750, 754, 755, 757)'],    
    ['Tarefa Fefo', 'lit', '(Ap. 7 - M. 39 - Pág. 159)', '(764, 766, 767, 768, 770)'],      
    ['Tarefa Thiagão', 'fis', '(Ap. 6 - M. 18 - Pág. 119)', '(342, 343,, 347, 350, 354)'],
    ['Tarefa Rose', 'qui', '(Ap. 7 - M. 41 - Pág. 133)', '(803, 805, 806, 808, 809, 810, 816)'], 
