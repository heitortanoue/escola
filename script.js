let tarefas = [    
    ['Tarefa Tio Dani', 'bio', '(Ap. 6 - M. 33 - Pág. 284)', '(641, 645, 647, 650, 651)'],
    ['Tarefa Renan', 'mat', '(Ap. 6 - M. 34 - Pág. 26)', '(661, 662, 665, 668, 671, 674, 676, 677)'],
    ['Tarefa Lucas', 'fis', '(Ap. 6 - M. 33 - Pág. 65)', '(641, 642, 645, 646, 648, 650)'],
    //['Tarefa Rose', 'qui', '(Ap. 6 - M. 36 - Pág. 153)', '(701, 707, 714, 716, 718, 719)'],
    ['Tarefa Tadaiti', 'qui', '(Ap. 6 - M. 17 - Pág. 200)' , '(322, 323, 326, 327, 330)'],
    ['Tarefa Felps', 'red', '(Ap. 5 - M. 14 - Pág. 218)' , '(216 e 267)'],
