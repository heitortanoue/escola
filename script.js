let tarefas = [       
    ['Tarefa Vlad', 'fil', '(Ap. 6 - M. 16 - Pág. 83)', '(281, 283, 284, 287, 289, 292, 293, 296, 298, 300)'],
    ['Tarefa João César', 'fis', '(Ap. 6 - M. 35 - Pág. 35)', '(682, 687, 689, 694, 696, 697)'],
    ['Tarefa Gui', 'his', '(Ap. 6 - M. 35 - Pág. 52)', '(681, 683, 685, 690, 692, 696, 697, 698)'],
    ['Tarefa Rodrigo', 'bio', '(Ap. 6 - M. 35 - Pág. 247)', '(682, 683, 687, 688, 691, 694, 699, 700)'],
    ['Tarefa Vini', 'mat', '(Ap. 7 - M. 20 - Pág. 94)' , '(382, 385, 387, 389, 390, 391)'],
    ['Tarefa Marcus Vinicius', 'qui', '(Ap. 6 - M. 36 - Pág. 182)' , '(701, 705, 706, 711)'],
